import sqlite3
from flask import g, render_template, request, redirect, url_for, Blueprint
...
def login():
    if request.method == 'POST':
        return redirect(
            url_for(
                'member_course_router.all_course',
...
def all_course(username):
    ...
    sql = """
        ...
        FROM
            ...
            coach AS ch
        WHERE
            c.dateStart > date(\'now\') AND
            c.coachID = ch.coachID
        ORDER BY
            c.dateStart
    """
